                                ...
                                <div className="flex items-center justify-between mb-3">
                                    ...
                                    {!isPublic && (
                                        <div className="flex items-center gap-1">
                                            <button
                                                className="p-1 text-muted-foreground hover:text-neutral-700 dark:hover:text-neutral-200 hover:bg-neutral-100 dark:hover:bg-neutral-800 rounded transition-colors"
                                            ...
                                            <DropdownMenu.Root>
                                                <DropdownMenu.Trigger asChild>
                                                    <button className="p-1 text-muted-foreground hover:text-neutral-700 dark:hover:text-neutral-200 hover:bg-neutral-100 dark:hover:bg-neutral-800 rounded transition-colors">
                                                ...
                                                <DropdownMenu.Portal>
                                                    <DropdownMenu.Content className="min-w-[160px] bg-white dark:bg-neutral-800 rounded-lg shadow-lg border border-neutral-200 dark:border-neutral-700 p-1 z-50" sideOffset={5}>
                                                        {index > 0 && (
                                                            <DropdownMenu.Item className="flex items-center gap-2 px-3 py-2 text-sm rounded cursor-pointer outline-none hover:bg-neutral-100 dark:hover:bg-neutral-800" onSelect={() => handleMoveColumn(column.id, 'forward')}>
                                                                <ChevronLeft size={14} />{t('actions.moveForward')}
                                                            </DropdownMenu.Item>
                                                        )}
                                                        {index < sortedColumns.length - 1 && (
                                                            <DropdownMenu.Item className="flex items-center gap-2 px-3 py-2 text-sm rounded cursor-pointer outline-none hover:bg-neutral-100 dark:hover:bg-neutral-800" onSelect={() => handleMoveColumn(column.id, 'backward')}>
                                                                <ChevronRight size={14} />{t('actions.moveBackward')}
                                                            </DropdownMenu.Item>
                                                        )}
                                                        <DropdownMenu.Separator className="h-px bg-neutral-200 dark:bg-neutral-700 my-1" />
                                                        <DropdownMenu.Item className="flex items-center gap-2 px-3 py-2 text-sm rounded cursor-pointer outline-none hover:bg-neutral-100 dark:hover:bg-neutral-800" onSelect={() => handleEditColumn(column.id)}>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="flex gap-1 mt-2">
                                                            ...
                                                            <button
                                                                ...
                                                                className="px-2 py-1 text-xs border dark:border-neutral-500 rounded hover:bg-neutral-100 dark:hover:bg-neutral-800"
                                                            >
                                                                {t('common.cancel')}
                                                            </button>
                                                        </div>
                                                    ...
                                                    <div className="flex items-start justify-between gap-1">
                                                        ...
                                                        {!isPublic && (
                                                            <button
                                                                ...
                                                                className="opacity-0 group-hover:opacity-100 p-0.5 text-muted-foreground hover:text-red-500 rounded transition-opacity"
                                                            >
                                                                <X size={12} />
                                                            </button>
                                                        )}
                                ...
                                {!isPublic && (
                                    <div className="mt-2 flex-shrink-0">
                                        {isAddingHere ? (
                                            ...
                                            <button
                                                onClick={() => { setAddingItemColumnId(column.id); setNewItemTitle('') }}
                                                className="w-full flex items-center gap-1 px-2 py-1.5 text-sm text-muted-foreground hover:text-neutral-700 dark:hover:text-neutral-300 hover:bg-neutral-100 dark:hover:bg-neutral-800 rounded transition-colors"
                                            >
                                                <Plus size={14} />
                                                {t('views.addItem', 'Add item')}
                                            </button>
