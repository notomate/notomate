      ...
      <div
        className={`relative file-node select-none rounded-lg p-3 flex items-center gap-3 transition-all ${
          selected
            ...
            : 'border border-gray-300 dark:border-neutral-700 bg-gray-50 dark:bg-neutral-800 hover:bg-gray-100 dark:hover:bg-neutral-800'
        }`}
      >
        ...
        <a
          href={src}
          download={name}
          className="p-1.5 text-muted-foreground hover:text-gray-900 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-neutral-800 rounded transition-colors"
          title="Download file"
        >
