    ...
    return (
        <div className="h-full flex flex-col bg-neutral-50 dark:bg-neutral-950">
            <div ref={scrollRef} className="flex-1 overflow-auto">      
                <div className="max-w-2xl px-4 pt-4 pb-2 mx-auto">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full pl-9 pr-9 py-2.5 text-sm rounded-lg bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700 text-gray-900 dark:text-gray-100 placeholder:text-gray-400 dark:placeholder:text-gray-500 outline-none focus:ring-2 focus:ring-neutral-300 dark:focus:ring-neutral-600 transition-shadow"
                        />
                        {query && (
                            <button
                                onClick={() => setQuery("")}
                                title={t("common.clear")}
                                className="absolute right-2 top-1/2 -translate-y-1/2 p-1 rounded-md text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors"
                            >
                                <X size={14} />
                            </button>
                        )}
