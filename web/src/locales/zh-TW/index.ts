export default {
  ...
  pages: {
    ...
    settings: {
      ...
      connectedRunners: "已連接的 Runner",
      connectedRunnersHint: "目前已連接到此站台的 runner。可在 workflow 的 runs-on: 欄位中使用其標籤來指定執行位置。",
      noConnectedRunners: "目前沒有已連接的 runner。",
      runsOnExample: "範例：workflow YAML 中的 runs-on:",
      workflowVars: "變數",
  ...
  messages: {
    ...
    avatarUploaded: "頭像更新成功",
    avatarRemoved: "頭像移除成功",
    avatarRemoveFailed: "移除頭像失敗",
    emailUpdated: "電子郵件更新成功",
    emailUpdateFailed: "電子郵件更新失敗",
    passwordUpdated: "密碼更新成功",
    passwordUpdateFailed: "密碼更新失敗",
    avatarUploadFailed: "頭像更新失敗",
    avatarInvalidType: "請選擇圖片檔案",
    avatarTooLarge: "圖片太大（最大 5MB）",
    networkError: "網路異常",
    fileUploaded: "檔案上傳成功",
